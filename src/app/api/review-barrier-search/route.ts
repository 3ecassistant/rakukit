...
import { analyzeReviewBarrier } from "@/lib/reviewBarrierAnalysis";
...
export async function POST(req: NextRequest) {
  ...
  const ownReviewCount = typeof body.ownReviewCount === "number" ? body.ownReviewCount : null;
  const lowReviewThreshold = typeof body.lowReviewThreshold === "number" ? body.lowReviewThreshold : 50;
  ...
  try {
    ...
    const analysis = analyzeReviewBarrier(items, totalCount, ownReviewCount, lowReviewThreshold);
