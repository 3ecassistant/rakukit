...
import { analyzePricePosition } from "@/lib/pricePositionAnalysis";
...
export async function POST(req: NextRequest) {
  ...
  const strongReviewCountThreshold = typeof body.strongReviewCountThreshold === "number" ? body.strongReviewCountThreshold : 100;
  const strongReviewAverageThreshold = typeof body.strongReviewAverageThreshold === "number" ? body.strongReviewAverageThreshold : 4.3;
  ...
  try {
    ...
    const analysis = analyzePricePosition(items, totalCount, ownPrice, strongReviewCountThreshold, strongReviewAverageThreshold);
